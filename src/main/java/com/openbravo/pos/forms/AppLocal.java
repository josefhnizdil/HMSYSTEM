...
public class AppLocal {
     ...
     *
     */
    public static final String APP_NAME = "hm Pokladní systém POS";

    /**
     *
     */

    public static final String APP_AUTHOR = "Josef Hnízdil";

    /**
     *
     */
    public static final String APP_ID = "hmsystems";
