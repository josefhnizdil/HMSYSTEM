...
//  JG 31 Aug 13 - Added DB Defaults
    ...
    private void initComponents() {
        ...
        jLabel5.setText(bundle.getString("label.DBText")); // NOI18N
...
//  JG 31 Aug 13 - Added DB Defaults
        ...
        if ("Apache Derby Embedded".equals(jcboDBDriver.getSelectedItem())) {
            ...
            jtxtDbURL.setText("jdbc:derby://localhost:1527/hmPOS");
            ...
            jtxtDbURL.setText("jdbc:mysql://localhost:3306/hmPOS");
            ...
            jtxtDbURL.setText("jdbc:oracle:thin://localhost:1521/hmPOS");
            ...
            jtxtDbURL.setText("jdbc:postgresql://localhost:5432/hmPOS");
        } else {
