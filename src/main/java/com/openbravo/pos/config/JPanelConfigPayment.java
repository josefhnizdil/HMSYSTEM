...
//    private Map<String, PaymentConfiguration> paymentsName = new HashMap<String, PaymentConfiguration>();
    ...
    public JPanelConfigPayment() {
        ...
        jcboCardReader.addItem("Bluetooth"); // Hugh Stevenson 02.06.2014
    }
    ...
    private void initComponents() {
        ...
        jcboCardReader.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcboCardReaderActionPerformed(evt);
            }
        });
...
private void jcboPaymentGatewayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcboPaymentGatewayActionPerformed
    ...
    private void jcboCardReaderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcboCardReaderActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jcboCardReaderActionPerformed
